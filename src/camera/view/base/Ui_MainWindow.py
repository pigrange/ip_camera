...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.connect_btn.setGeometry(QtCore.QRect(600, 640, 120, 40))
        font = QtGui.QFont()
        ...
        self.rotate_left_btn.setGeometry(QtCore.QRect(580, 695, 80, 28))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.rotate_left_btn.setFont(font)
        self.rotate_left_btn.setObjectName("rotate_left")

        self.rotate_right_btn = QtWidgets.QPushButton(self.centralwidget)
        self.rotate_right_btn.setGeometry(QtCore.QRect(665, 695, 80, 28))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.rotate_right_btn.setFont(font)
        self.rotate_right_btn.setObjectName("rotate_right")
        ...
        self.connect_state.setGeometry(QtCore.QRect(230, 700, 91, 21))
        font = QtGui.QFont()
        font.setPointSize(11)
        self.connect_state.setFont(font)
        self.connect_state.setObjectName("connect_statu")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.connect_state.setText(_translate("MainWindow", "未连接"))
        self.rotate_left_btn.setText(_translate("MainWindow", "左旋90度"))
        self.rotate_right_btn.setText(_translate("MainWindow", "右旋90度"))
